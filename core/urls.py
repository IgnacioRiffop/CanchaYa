...
urlpatterns = [
    ...
    path('administradores/', views.crudAdministradores, name='crudAdministradores'),
    path('usuarios/', views.crudUsuarios, name='crudUsuarios'),
    ...
    path('crudTarifas/<int:pk>/activar/', views.tarifa_activate, name='tarifa_activate'),
